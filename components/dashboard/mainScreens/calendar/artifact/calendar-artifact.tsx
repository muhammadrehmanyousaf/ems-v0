...
.callayout{ display:grid; grid-template-columns:minmax(0,1fr) 322px; gap:14px; align-items:stretch; height:calc(100dvh - 150px); min-height:380px; } @media (max-width:1140px){ .callayout{ grid-template-columns:1fr; height:auto; } }
