                  ...
                  >
                    ...
                    {detail.package && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-bridal-gold font-medium">
                          Rs.{" "}
                          {Number(detail.package.price || 0).toLocaleString()}
                        </span>
                      </div>
                    )}
                    {detail.menu && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-bridal-gold font-medium">
                          Rs. {Number(detail.menu.price || 0).toLocaleString()}
                        </span>
                      </div>
                    )}
                    ...
                    <div className="flex justify-between text-xs text-neutral-400">
                      ...
                      <span>
                        Rs. {Number(detail.downPayment || 0).toLocaleString()}
                      </span>
                    </div>
                  </div>
                ))}
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-neutral-500 mt-0.5">
                      Available for 7 days after the event. Filing pauses
                      payouts and triggers an admin review.
                    </p>
                  </div>
