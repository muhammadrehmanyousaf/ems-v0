  ...
  return (
    <div className="space-y-6 p-4 md:p-6">
      <PageHeader
        ...
        actions={<Button><Icon name="Plus" size={16} className="mr-1.5" /> Log a cheque</Button>}
      />
      ...
      <DataTable
        ...
        empty={{
          ...
          action: <Button size="sm"><Icon name="Plus" size={14} className="mr-1" /> Log a cheque</Button>,
        }}
        toolbar={
          <>
