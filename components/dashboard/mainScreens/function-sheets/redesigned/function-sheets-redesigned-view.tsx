...
export function FunctionSheetsRedesignedView() {
  ...
  const [deleting, setDeleting] = React.useState<FunctionSheet | null>(null)
    ...
    <div className="space-y-6 p-4 md:p-6">
      ...
      <DataTable
        ...
        empty={{
          ...
          action: <Button size="sm" onClick={() => setDialogOpen(true)}><Icon name="Plus" size={14} className="mr-1" /> New function sheet</Button>,
        }}
        toolbar={
          <>
      ...
      <NewFunctionSheetDialog open={dialogOpen} onOpenChange={setDialogOpen} businessId={businessId} onCreated={(id) => toComposer(id)} />

      <AlertDialog open={!!deleting} onOpenChange={(v) => !v && setDeleting(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Remove this function sheet?</AlertDialogTitle>
            <AlertDialogDescription>{deleting?.title || "This sheet"} will be removed. This can't be undone.</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
