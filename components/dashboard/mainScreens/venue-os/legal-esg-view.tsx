        ...
        {(
          <div className="space-y-2 rounded-md border p-3 text-sm">
            <div className="flex flex-wrap items-end gap-2">
              ...
              <input type="text" value={item} onChange={(e) => setItem(e.target.value)} className="w-40 rounded-md border border-input bg-background px-2 py-1 text-sm outline-none focus-visible:ring-2 focus-visible:ring-ring" />
