    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="flex flex-wrap items-end gap-2 text-sm">
          ...
          <label className="flex flex-col gap-0.5 text-[11px] font-medium text-muted-foreground">Season year<input min={0} type="number" placeholder="season year" value={seasonYear} onChange={(e) => setSeasonYear(e.target.value)} className="w-28 rounded-md border border-input bg-background px-2 py-1 text-sm outline-none focus-visible:ring-2 focus-visible:ring-ring" /></label>
          <label className="flex flex-col gap-0.5 text-[11px] font-medium text-muted-foreground">Opening cash<input min={0} type="number" placeholder="opening cash" value={openingCash} onChange={(e) => setOpeningCash(e.target.value)} className="w-32 rounded-md border border-input bg-background px-2 py-1 text-sm outline-none focus-visible:ring-2 focus-visible:ring-ring" /></label>
