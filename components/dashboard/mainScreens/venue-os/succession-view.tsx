    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex flex-wrap items-end gap-2 rounded-md border p-3 text-sm">
          ...
          <label className="flex flex-col gap-0.5 text-[11px] font-medium text-muted-foreground">Partner #<input min={0} type="number" placeholder="partner #" value={partnerId} onChange={(e) => setPartnerId(e.target.value)} className="w-24 rounded-md border border-input bg-background px-2 py-1 text-sm outline-none focus-visible:ring-2 focus-visible:ring-ring" /></label>
