      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2 rounded-md border p-3">
          <div className="flex flex-wrap items-end gap-2 text-sm">
            ...
            <label className="flex flex-col gap-0.5 text-[11px] font-medium text-muted-foreground">Tag #<input type="text" placeholder="tag #" value={tag} onChange={(e) => setTag(e.target.value)} className="w-20 rounded-md border border-input bg-background px-2 py-1 text-sm outline-none focus-visible:ring-2 focus-visible:ring-ring" /></label>
        ...
        <div className="space-y-2 rounded-md border p-3">
          <div className="flex flex-wrap items-end gap-2 text-sm">
            ...
            <label className="flex flex-col gap-0.5 text-[11px] font-medium text-muted-foreground">Found by user #<input min={0} type="number" placeholder="found by user#" value={lfFound} onChange={(e) => setLfFound(e.target.value)} className="w-28 rounded-md border border-input bg-background px-2 py-1 text-sm outline-none focus-visible:ring-2 focus-visible:ring-ring" /></label>
            {highValue && <label className="flex flex-col gap-0.5 text-[11px] font-medium text-muted-foreground">Witness user #<input min={0} type="number" placeholder="witness user#" value={lfWitness} onChange={(e) => setLfWitness(e.target.value)} className="w-28 rounded-md border border-input bg-background px-2 py-1 text-sm outline-none focus-visible:ring-2 focus-visible:ring-ring" /></label>}
