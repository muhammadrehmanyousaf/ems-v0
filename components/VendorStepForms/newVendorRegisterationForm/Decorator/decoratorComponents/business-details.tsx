...
const BusinessDetails = ({ errors, setErrors }: BusinessDetails) => {
    ...
    const types = [
        { value: "Wedding", label: "Wedding Decoration", icon: <FaCircle /> },
        { value: "Event", label: "Event Decoration", icon: <FaCircle /> },
        { value: "Theme", label: "Theme Decoration", icon: <FaCircle /> },
        { value: "Outdoor", label: "Outdoor Decoration", icon: <FaCircle /> },
        { value: "Indoor", label: "Indoor Decoration", icon: <FaCircle /> },
    ];
