...
const BusinessDetails = ({ errors, setErrors }: BusinessDetails) => {
    ...
    const types = [
        { value: "Wedding", label: "Wedding Catering", icon: <FaCircle /> },
        { value: "Corporate", label: "Corporate Catering", icon: <FaCircle /> },
        { value: "Events", label: "Event Catering", icon: <FaCircle /> },
        { value: "Buffet", label: "Buffet Service", icon: <FaCircle /> },
        { value: "Plated", label: "Plated Service", icon: <FaCircle /> },
    ];
