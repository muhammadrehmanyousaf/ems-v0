...
const BusinessDetails = ({ errors, setErrors }: BusinessDetails) => {
    ...
    const Expertise = [
        { value: "Bridal Henna", label: "Bridal Henna" },
        { value: "Party Henna", label: "Party Henna" },
        { value: "Engagement Henna", label: "Engagement Henna" },
        { value: "Traditional Designs", label: "Traditional Designs" },
        { value: "Modern Designs", label: "Modern Designs" },
        { value: "Arabic Designs", label: "Arabic Designs" },
        { value: "Indo-Arabic Designs", label: "Indo-Arabic Designs" },
    ];

    const types = [
        { value: "Traditional", label: "Traditional Henna", icon: <FaCircle /> },
        { value: "Modern", label: "Modern Henna", icon: <FaCircle /> },
        { value: "Arabic", label: "Arabic Henna", icon: <FaCircle /> },
        { value: "Indo-Arabic", label: "Indo-Arabic Henna", icon: <FaCircle /> },
        { value: "Fusion", label: "Fusion Designs", icon: <FaCircle /> },
    ];

    const amenitiesData = [
        { value: "Natural Henna", label: "Natural Henna" },
        ...
        { value: "Aftercare Kit", label: "Aftercare Kit" },
                    ...
                    <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-neutral-200">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <Textarea
                                    id="description"
                                    placeholder="Describe your henna services"
