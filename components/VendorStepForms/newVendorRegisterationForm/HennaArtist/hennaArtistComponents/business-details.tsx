...
const BusinessDetails = ({ errors, setErrors }: BusinessDetails) => {
    ...
    const types = [
        { id: "Traditional", label: 'Traditional Henna' },
        { id: "Modern", label: 'Modern Henna' },
        { id: "Arabic", label: 'Arabic Henna' },
        { id: "Indo-Arabic", label: 'Indo-Arabic Henna' },
        { id: "Fusion", label: 'Fusion Designs' },
    ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-neutral-200">
                        ...
                        <div className="space-y-6">
                            <div>
                                <Label className="text-sm font-medium text-neutral-700 mb-2 block">Henna Style</Label>
                                <RadioButton
                                    data={types}
