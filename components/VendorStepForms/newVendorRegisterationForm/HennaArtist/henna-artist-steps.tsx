...
import BusinessDetails from './hennaArtistComponents/business-details';
import HennaArtistSpecialtyTrust from './hennaArtistComponents/specialty-trust';
import Packages from '../../packages';
import ImagesStep from '../../images-step';
import Preview from '../../preview';

interface HennaArtistStepsProps {
    currentStep: number;
    error: {};
...
// VR-050 — henna-artist flow gained "Specialty & Trust" at step 4.
const HennaArtistSteps = ({ currentStep, error, setErrors, file, setFile }: HennaArtistStepsProps) => {
    return (
        <>
            {currentStep === 1 ?
                        ...
                        : currentStep === 4 ?
                            <div className='space-y-6'>
                                <div className="space-y-3 mb-6">
                                    ...
                                    <p className="text-sm md:text-base lg:text-lg font-medium">Optional — henna specialty details brides ask about before booking.</p>
                                </div>
                                <HennaArtistSpecialtyTrust />
                            </div>
                            : currentStep === 5 ?
                                <div className='space-y-6'>
                                    <div className="space-y-3 mb-6">
...
export default HennaArtistSteps
