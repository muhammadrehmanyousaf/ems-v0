...
const CarRentalBusinessDetails = ({ errors, setErrors }: BusinessDetailsProps) => {
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="flex gap-3 mt-1">
                                    ...
                                    <Input
                                        type="number"
                                        placeholder={downPaymentType === 'Percentage' ? 'e.g. 20' : 'e.g. 5000'}
...
export default CarRentalBusinessDetails;
