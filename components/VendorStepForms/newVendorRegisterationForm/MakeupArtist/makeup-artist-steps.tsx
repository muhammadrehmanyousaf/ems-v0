...
import BusinessDetails from './makeupArtistComponents/business-details';
import MakeupArtistSpecialtyTrust from './makeupArtistComponents/specialty-trust';
import Packages from '../../packages';
import ImagesStep from '../../images-step';
import Preview from '../../preview';

interface MakeupArtistStepsProps {
    currentStep: number;
    error: {};
...
// VR-050 — makeup-artist flow gained "Specialty & Trust" at step 4.
const MakeupArtistSteps = ({ currentStep, error, setErrors, file, setFile }: MakeupArtistStepsProps) => {
    return (
        <>
            {currentStep === 1 ?
                        ...
                        : currentStep === 4 ?
                            <div className='space-y-6'>
                                <div className="space-y-3 mb-6">
                                    ...
                                    <p className="text-sm md:text-base lg:text-lg font-medium">Optional — makeup specialty details brides want before booking.</p>
                                </div>
                                <MakeupArtistSpecialtyTrust />
                            </div>
                            : currentStep === 5 ?
                                <div className='space-y-6'>
                                    <div className="space-y-3 mb-6">
...
export default MakeupArtistSteps
