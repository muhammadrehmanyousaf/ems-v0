      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
            {/* BUG-010 — Radix requires a title for the drawer to be accessible;
                the mobile sidebar had none. Screen-reader-only, no visual change. */}
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-1 overflow-auto hide-scrollbar group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
