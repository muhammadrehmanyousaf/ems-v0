        ...
        <div className="mb-4 sm:mb-6">
          <Breadcrumb>
            <BreadcrumbList className="text-xs sm:text-sm">
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage className="truncate max-w-[120px] sm:max-w-none">{vendor.name}</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                      <div className="space-y-2 sm:space-y-3">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6">
                            ...
                            <span className="ml-1 sm:ml-2 text-xs sm:text-base text-neutral-600">({reviews.length} reviews)</span>
                            </div>
                            <div className="flex items-center gap-2">
              ...
              <CardContent>
                ...
                {selectedDate && (
                  <div className="mt-4 p-3 rounded-lg bg-neutral-50">
                    ...
                    <p className={`text-sm ${isDateAvailable ? 'text-green-600' : 'text-red-600'}`}>
