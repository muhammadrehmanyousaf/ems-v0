    ...
    <section className="py-6 sm:py-8 md:py-12 lg:py-16 bg-gradient-to-br from-bridal-cream/30 via-white to-gold-50/20">
      <div className="w-full px-2 sm:px-4 md:px-6 lg:px-8 xl:px-12">
        <div className="flex justify-between items-end mb-12">
          <div>
            <SectionHeading title="Featured Car Rental" subtitle="Luxury Rides" />
            <p className="text-muted-foreground mt-2">Luxury cars and transportation for your wedding day</p>
          </div>
          <Link href="/car-rental" className="text-bridal-gold-dark hover:text-bridal-gold-dark hover:underline hidden md:block font-medium">
            View all car rental &rarr;
          </Link>
        </div>
        ...
        <div className="text-center mt-8 md:hidden">
          <Link href="/car-rental" className="text-bridal-gold-dark hover:text-bridal-gold-dark hover:underline font-medium">
            View all car rental &rarr;
          </Link>
        </div>
      </div>
