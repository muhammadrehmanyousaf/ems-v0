// Clean Backend Payment Endpoints Implementation
      ...
      if (stripePaymentIntent.status === 'requires_payment_method' || 
        ...
        return res.json({
          ...
          data: {
            ...
            bookingDetails: {
              id: bookingId,
              customerName: "Customer Name", // You'll need to get this from your database
              bookingDate: "2024-01-01T00:00:00.000Z", // You'll need to get this from your database
              bookingTime: "14:00", // You'll need to get this from your database
              status: "Pending", // You'll need to get this from your database
              paymentStatus: "Pending", // You'll need to get this from your database
              businesses: [
                {
                  id: 1,
            ...
            paymentDetails: {
              ...
              expectedAmount: stripePaymentIntent.amount / 100
            }
          }
        });
      }
