...
export default function WeddingStationeryDetailsPage() {
    ...
    return (
      <div className="min-h-screen bg-bridal-ivory flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-neutral-600 text-lg">Loading wedding stationery vendor details...</p>
          <p className="text-sm text-neutral-500 mt-2">Please wait while we fetch the wedding stationery vendor information</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-bridal-ivory flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <h2 className="text-xl font-semibold text-neutral-900 mb-2">Unable to Load Wedding Stationery Vendor</h2>
    ...
    return (
      <div className="min-h-screen bg-bridal-ivory flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <h2 className="text-xl font-semibold text-neutral-900 mb-2">Wedding Stationery Vendor Not Found</h2>
          <p className="text-neutral-600 mb-6">The wedding stationery vendor you're looking for doesn't exist or has been removed.</p>
          <Button 
            onClick={handleGoBack}
