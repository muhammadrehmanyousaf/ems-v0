...
export default function DecorDetailsPage() {
  ...
  useEffect(() => {
    const fetchVendorDetails = async () => {
      ...
      try {
        ...
        console.log('🔍 Fetching decor vendor details for ID:', id)
        
        // Fetch vendor details from API
        const vendorData = await VendorAPI.getBusinessById(id)
        
        if (vendorData) {
          console.log('✅ Decor vendor data received:', vendorData)
          setVendor(vendorData)
        } else {
          console.log('❌ No decor vendor data received from API')
          throw new Error('Decor vendor not found')
        }
      } catch (err) {
        console.error('❌ Error fetching decor vendor details:', err)
        ...
        try {
          ...
          if (storedVendors) {
            ...
            if (storedVendor) {
              console.log('✅ Found decor vendor in localStorage fallback')
        ...
        setError(err instanceof Error ? err.message : 'Failed to load decor vendor details. Please try again.')
      } finally {
        setIsLoading(false)
      }
    }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-rose-50 to-pink-50 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <h2 className="text-xl font-semibold text-neutral-900 mb-2">Unable to Load Decor Vendor</h2>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-rose-50 to-pink-50 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <h2 className="text-xl font-semibold text-neutral-900 mb-2">Decor Vendor Not Found</h2>
