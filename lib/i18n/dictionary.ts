...
const EN: Dictionary = {
  ...
  "nav.tax": "Tax report",
  "nav.more": "More",
  "nav.holds": "Date holds",
  "nav.reports": "Reports",
  "nav.kitchen_prep": "Kitchen prep",
  "nav.trade_ops": "Trade operations",
  "nav.availability": "Availability",
  "nav.cancellation_policy": "Cancellation policy",
...
const UR: Dictionary = {
  ...
  "nav.tax": "ٹیکس رپورٹ",
  "nav.more": "مزید",
  "nav.holds": "تاریخ ہولڈ",
  "nav.reports": "رپورٹس",
  "nav.kitchen_prep": "کچن تیاری",
  "nav.trade_ops": "ٹریڈ آپریشنز",
  "nav.availability": "دستیابی",
  "nav.cancellation_policy": "منسوخی پالیسی",
  ...
  "nav.promote": "تشہیر",
  "nav.billing": "پلان اور بلنگ",
  "nav.collaborations": "اشتراک",
