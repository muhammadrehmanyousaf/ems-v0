...
export const THEMES: Record<ThemeName, { light: TokenMap; dark: TokenMap }> = {
  champagne: {
    // Approved artifact palette (docs/design-samples) — warm off-white ground +
    // one gold accent, near-black espresso in dark. White-on-gold for the
    // primary button label matches the samples (AA-large for the bold label).
    light: tokens("45 20% 96%", "36 11% 9%", "0 0% 100%", "36 11% 9%",
      "36 51% 48%", "0 0% 100%", "43 23% 94%", "34 8% 35%",
      "43 23% 94%", "40 6% 41%", "43 23% 94%", "36 11% 9%",
      "2 40% 45%", "0 0% 100%", "45 17% 91%", "36 51% 48%",
      "0 0% 100%", "34 8% 35%", "36 51% 48%", "0 0% 100%",
      "43 23% 94%", "36 11% 9%", "45 17% 91%"),
    dark: tokens("40 14% 4%", "40 31% 94%", "40 16% 7%", "40 31% 94%",
      "37 62% 60%", "40 63% 8%", "40 18% 10%", "38 10% 63%",
      "40 18% 10%", "35 10% 56%", "40 18% 10%", "40 31% 94%",
      "3 50% 71%", "40 63% 8%", "42 15% 13%", "37 62% 60%",
      "40 16% 7%", "38 10% 63%", "37 62% 60%", "40 63% 8%",
      "40 18% 10%", "40 31% 94%", "42 15% 13%"),
  },
  indigo: {
