...
| 7 | `DATABASE_URL` | Railway `postgresql://neondb_owner:npg_sAPoIl8chtk9@ep-divine-dream-...neon.tech/neondb` | **Railway dashboard** — reset `neondb_owner` password / rotate role; update Railway `DATABASE_URL`. |
...
- **Railway** → reset/rotate the `neondb_owner` credential.
